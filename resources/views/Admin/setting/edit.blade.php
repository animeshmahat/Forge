    ...
    <div class="col-12">
        ...
        <div class="card mt-3 p-3">
            <form action="{{route('admin.setting.update', ['id' => $data['row']->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4 mt-2">
                    <label for="site_first_address" class="form-label"><strong>Address</strong></label>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" name="meta_description" placeholder="Add Keywords...." cols="30" rows="5" style="resize: none;">{{ $data['row']->meta_description }}</textarea>
                </div>
