    ...
    <div class="row">
        ...
        <div class="col-sm-6 card p-2 m-2">
            <div class="d-flex flex-row justify-content-between">
                ...
                <a href="{{ route('admin.setting.edit' , ['id' => $site->id]) }}" class="btn btn-sm btn-danger mt-auto mb-auto"><i class="fa-solid fa-pen"></i> Edit {{$_panel}} </a>
            </div>
            <hr>
            <form action="">
                <div class="mt-2 mb-2">
                ...
                <div class="mt-2 mb-2">
                    <label for="site_address" class="form-label font-weight-bold">First Address</label>
                    <input type="text" class="form-control ms-auto" value="{{$site->site_address}}" disabled>
                </div>
                <div class="mt-2 mb-2">
                ...
                <div class="mt-2 mb-2">
                    ...
                    <textarea class="form-control ms-auto" disabled style="resize: none;">{{strip_tags($site->meta_description)}}</textarea>
                </div>
                <div class="mt-2 mb-2">
                    <label for="meta_keywords" class="form-label font-weight-bold">Meta Keywords</label>
                    <input type="text" class="form-control ms-auto" value="{{$site->meta_keywords}}" disabled>
                </div>
            </form>
        </div>
        <div class="col-sm-5 d-flex flex-column justify-content-center mb-auto">
            <!-- second card -->
            <div class="card m-2 bg-gradient-primary text-light">
                <div class="d-flex flex-row justify-content-between pt-2 px-2">
                    <h2 class="mt-2">Logo & Favicon</h2>
                    <a href="{{ route('admin.setting.edit_site_image', ['id' => $site->id]) }}" class="btn btn-sm btn-danger mt-auto mb-auto"><i class="fa-solid fa-pen"></i> Edit</a>
                </div>
                <hr>
            ...
            <div class="card m-2">
                <div class="d-flex flex-row justify-content-between pt-2 px-2">
                    ...
                    <a href="{{ route('admin.setting.edit_socials', ['id' => $site->id]) }}" class="btn btn-sm btn-danger mt-auto mb-auto"><i class="fa-solid fa-pen"></i> Edit</a>
                </div>
                <hr>
