...
<head>
    ...
    @if(isset($all_view['setting']->meta_description) && isset($all_view['setting']->meta_keywords))
    <meta name="description" content="{{asset($all_view['setting']->meta_description)}}">
    <meta name="author" content="{{asset($all_view['setting']->meta_keywords)}}">
    @endif

    <link rel="icon" type="image/x-icon" href="{{asset($all_view['setting']->favicon)}}">

    <title>Forge | @yield('title')</title>
