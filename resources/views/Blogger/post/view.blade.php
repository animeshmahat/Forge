...
<div class="row">
    <div class="col">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <!-- posted at -->
                            <div class="mb-2">
                                <p><strong>POSTED AT:</strong> {{ $data['row']->created_at->format('h:i:s D-m-d-Y') }}</p>
                            </div>
        ...
        <!-- back-button -->
        <a href="{{route('blogger.post.index')}}" class="btn btn-primary btn-sm mt-2 mb-4"><i class="fa-solid fa-backward"></i> RETURN</a>
