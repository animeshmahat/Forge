...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mt-3 p-3">
            <form action="{{ route('blogger.post.update', $data['row']->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                ...
                <!-- buttons -->
                <div class="mt-2">
                    <a href="{{ route('blogger.post.index') }}" class="btn btn-sm btn-danger mb-4"><i class="fa fa-ban" aria-hidden="true"></i> CANCEL</a>
